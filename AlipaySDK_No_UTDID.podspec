#
#  Be sure to run `pod spec lint Alipay-SDK-No-UTDID-Brian.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Brian" => "Brianyin.yr@foxmail.com" }
  # Or just: s.author    = "Brian"
  # s.authors            = { "Brian" => "Brianyin.yr@foxmail.com" }
  s.social_media_url   = "https://github.com/BrianyinIOS"
